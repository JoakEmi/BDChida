 ...
 * @author Lenovo
 */
public class CambiosProveedores extends javax.swing.JFrame {

    /**
     * Creates new form CambiosProveedores
     */
    public CambiosProveedores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cambios Proveedores");
        ...
        if(!txtTelefonoProveedor.getText().equals("") && !txtEmailProveedor.getText().equals("")){
            ...
            try{
                 ...
                 String sql = "UPDATE Proveedores "
                            + "SET TelefonoProveedor = '" + txtTelefonoProveedor.getText() + "', "
                            + "EmailProveedor = '" + txtEmailProveedor.getText() + "' "
                            + "WHERE IdProveedor = '" + txtId.getText() +"' ;";
